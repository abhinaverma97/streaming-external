...
function HeroSectionInner({
    ...
    return (
        <section className="relative min-h-[300px] md:h-[66vh] w-full rounded-2xl overflow-hidden border border-slate-800/40 shadow-2xl bg-[#090b14]/40 backdrop-blur-xl mt-4 md:mt-0">
            {selectedMovie && (
